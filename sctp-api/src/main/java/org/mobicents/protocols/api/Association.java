 ...
 * </p>
 * <p>
 * The implementation of this interface is actual wrapper over Socket that know's how to communicate with peer. The user
 * of Association shouldn't care if the underlying Socket is client or server side
 * </p>
 * <p>
 *
 * </p>
...
public interface Association
{
	...
	/**
	 * Use this method only for accepting anonymous connections from the ServerListener.onNewRemoteConnection()
	 * invoking
	 *
	 * @param associationListener
	 *
	...
	/**
	 * Use this method only for rejecting anonymous connections from the ServerListener.onNewRemoteConnection()
	 * invoking
	 */
	public void rejectAnonymousAssociation();

	/**
	 * Stop the anonymous association. The connection will be closed and we will not reuse this association This can be
	 * applied only for anonymous association, other associations must be stopped by Management.stopAssociation(String
	 * assocName)
	 *
	 * @throws Exception
	 */
