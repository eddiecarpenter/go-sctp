...
public class PayloadData
{
	 ...
	 * </p>
	 * <p>
	 * While sending PayloadData to SCTP Association, this value should be set by SCTP user. If value greater than or
	 * equal to maxOutboundStreams or lesser than 0 is used, packet will be dropped and error message will be logged
	 * </p>
	 * </p> While PayloadData is received from underlying SCTP socket, this
	 * value indicates stream identifier on which data was received. Its guaranteed that this value will be greater than
	 * 0 and less than maxInboundStreams
	 * <p>
	 *
